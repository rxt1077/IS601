...
Use VSCode to open up the _exercise_5_ directory in your copy of https://github.com/~rt494/is601.git[the class git repo] and add a new file named _dates.py_.
