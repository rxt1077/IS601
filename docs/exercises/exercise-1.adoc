...
https://www.python.org/ftp/python/3.9.5/python-3.9.5-amd64.exe[Windows installer package].
Alternative packages can be found
https://www.python.org/downloads/release/python-395/[here].
...
If you do not already have Python 3 installed, you can use this
https://www.python.org/ftp/python/3.9.5/python-3.9.5-macos11.pkg[MacOS installer package].
Alternative packages can be found 
https://www.python.org/downloads/release/python-395/[here].
